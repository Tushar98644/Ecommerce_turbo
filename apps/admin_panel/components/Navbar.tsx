...
const Navbar = () => {
    const inactivelink = "flex flex-row gap-2 ml-2 pl-2";
    ...
    return (
        <div className="flex flex-col p-2 text-white gap-8 lg:p-10 ">
            ...
            <nav className="flex gap-3 flex-col items-start text-lg">
                ...
                <div className={pathname.includes('/product') ? activelink:  inactivelink}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z" />
                    </svg>
                    <Link href={'/product'}>Product</Link>
                </div>
                <div className={pathname.includes('/order') ? activelink:  inactivelink}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
